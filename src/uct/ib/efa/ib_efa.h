...
uct_ib_efadv_max_sq_wr(const uct_ib_efadv_t *efadv)
{
    return efadv->attr.max_sq_wr;
}

static inline uint32_t
uct_ib_efadv_max_rq_wr(const uct_ib_efadv_t *efadv)
{
    return efadv->attr.max_rq_wr;
}

static inline uint16_t
uct_ib_efadv_max_sq_sge(const uct_ib_efadv_t *efadv)
{
    return efadv->attr.max_sq_sge;
}

static inline uint16_t
uct_ib_efadv_max_rq_sge(const uct_ib_efadv_t *efadv)
{
    return efadv->attr.max_rq_sge;
}

static inline uint16_t
uct_ib_efadv_inline_buf_size(const uct_ib_efadv_t *efadv)
{
    return efadv->attr.inline_buf_size;
}

static inline uint32_t
uct_ib_efadv_max_rdma_size(const uct_ib_efadv_t *efadv)
{
    if (uct_ib_efadv_has_rdma_read(efadv)) {
        return efadv->attr.max_rdma_size;
    }
